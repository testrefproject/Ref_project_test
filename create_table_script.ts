...
const { text, textNullable, integer, integerNullable, date ,serialPrimaryKey} = dvts.domains;
...
const MedigyPredictionResult = SQLa.tableDefinition("langchain_predictions_result", {  
  ...
  prediction_score_title: textNullable(),
  related_topic_with_content: textNullable(),
  prediction_score_content: textNullable(),
  related_topic_with_title_and_content: textNullable(),
  prediction_score_title_content: textNullable(),  
