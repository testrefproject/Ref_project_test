  ...
  return SQLa.SQL<EmitContext>(dvts.ddlOptions)`
    ...
    ${ schemaName
       ...
       : "-- no schemaName provided" }
        ...
        select stateful_service_medigy_rdv_miniflux.predictions_result_sf_insert();
        select stateful_service_medigy_rdv_miniflux.general_predictions_result_sf_insert();
